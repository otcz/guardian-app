...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, FormsModule, RouterModule, CardModule, DropdownModule, ButtonModule],
...
export class UsuarioAsignarSeccionComponent implements OnInit {
  ...
  constructor(private orgCtx: OrgContextService, private users: UsersService, private seccionesSrv: SeccionService, private notify: NotificationService, private router: Router, private confirm: ConfirmationService) {}
